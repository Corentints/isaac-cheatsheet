            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-4">
                        ...
                        {transformation.trinkets && <p className="text-xs text-gray-400 mb-2">or
                            {(transformation.trinkets.length === 1) ? " trinket" : " trinkets"} : </p>}
                        ...
                        <>
                            <span className="text-xs text-gray-400 mb-2 mt-5">{transformation.requirements}
                                <img src="./images/transformations/transformation_pill.png" alt=""
                                     className="pixelated inline pl-2"/>
                            </span>
                        </>}
